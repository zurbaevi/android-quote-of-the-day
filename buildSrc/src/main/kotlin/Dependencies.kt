object Dependencies {
    ...
    const val TEST_JUNIT: String = "androidx.test.ext:junit:${Versions.TEST_JUNIT}"
    ...
    const val LEAK_CANARY: String = "com.squareup.leakcanary:leakcanary-android:${Versions.LEAK_CANARY}"
